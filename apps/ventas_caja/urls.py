...
from .views import (
    ...
    CajaHistorialView,
    CajaResumenView,
    CampaniaFidelizacionActivarView,
    CampaniaFidelizacionDetalleView,
    CampaniaFidelizacionListCreateView,
...
urlpatterns = [
    ...
    path('campanias-fidelizacion/', CampaniaFidelizacionListCreateView.as_view(), name='campania-fidelizacion-list-create'),
    path('campanias-fidelizacion/<int:id_campania>/', CampaniaFidelizacionDetalleView.as_view(), name='campania-fidelizacion-detalle'),
    path('campanias-fidelizacion/<int:id_campania>/activar/', CampaniaFidelizacionActivarView.as_view(), name='campania-fidelizacion-activar'),
